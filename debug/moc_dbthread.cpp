...
void DBThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DBThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (DBThread::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DBThread::isDone)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DBThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_DBThread.data,
    qt_meta_data_DBThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
